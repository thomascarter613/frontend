export const COMMANDS = Object.freeze([
  ...
  { id: 'history.undo', label: 'Undo', shortcut: 'Ctrl/Cmd+Z' },
  { id: 'history.redo', label: 'Redo', shortcut: 'Ctrl/Cmd+Shift+Z' },
  { id: 'system.openRecovery', label: 'Open Recovery Center' },
  { id: 'system.openDiagnostics', label: 'Open Diagnostics' },
  { id: 'jobs.retryFailed', label: 'Retry Failed Jobs', capability: 'job.start' },
